"use client"
import { createGasto, editGasto } from "@/app/actions";
...
export default function EditGastosForm({data}:editGastoProps) {

    const [lastResult, action] = useActionState(editGasto, undefined);
    ...
    return(
        ...
        <Card className="mt-5">
            ...
            <CardFooter>
                <SubmitButton text="Actualizar Gasto"/>
            </CardFooter>
            </form>
        </Card>
        </>
