import {  DeleteSucursal, DeleteUser } from "@/app/actions";
    ...
    return(
        ...
        <div className="h-[80vh] w-full flex items-center justify-center">
            <Card className="w-full max-w-xl">
                <CardHeader>
                    <CardTitle>Esta seguro que desea eliminar la sucursal?</CardTitle>
                ...
                <CardContent className="w-full flex justify-between">
                    ...
                    <form action={DeleteSucursal}>
                        <input type="hidden" name="id" value={id} />
                        <input type="hidden" name="username" value={username} />
                        <DeleteButton text="Eliminar Sucursal" />
                    </form>
                </CardContent>
            </Card>
        </div>
